...
Betas=matrix(list(),length(Lineages),length(Pathways))
Scores=matrix(list(),length(Lineages),length(Pathways))
Status=matrix(list(),length(Lineages),length(Pathways))
Graphs=matrix(list(),length(Lineages),length(Pathways))
Errors=matrix(0,length(Lineages),length(Pathways))

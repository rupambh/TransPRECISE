...
saveWidget(SankeyDiagram(MatchingOnly[,c(1,3,2)],font.size=0,label.show.varname=FALSE,link.color="Source"),"Matching.html")
webshot("Everything.html","Everything.png")
webshot("Matching.html","Matching.png")